...
<html lang="en">
    <head>
        ...
        <!--===============================================================================================-->
        <link rel="stylesheet" type="text/css" href="view/css/ut.css">
        <link rel="stylesheet" type="text/css" href="view/css/SDDa.css">
        <!--===============================================================================================-->
        <style>
            .myname
            {
    ...
    <body>
        ...
        <script src="view/js/GetMedicine.js"></script> 
    </body>
</html>