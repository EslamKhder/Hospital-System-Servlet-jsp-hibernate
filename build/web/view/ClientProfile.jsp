...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                <img src="images/p4.jpg" alt="" class="profile-img">
                ...
                <div class="content">
                    ...
                    <div class="data">
                        ...
                        <div class="btn"><a href="MainClient.jsp">Main</a></div>
                        <div class="btn"><a href="EditClient.jsp">UP_Date</a></div>
                        <div class="btn"><a href="YourPassword.jsp">Delete</a></div>
                </div>
            </div>
        </div>
